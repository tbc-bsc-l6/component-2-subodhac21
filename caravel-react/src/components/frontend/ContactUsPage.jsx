    ...
    <div className="flex flex-wrap">
        ...
        <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
            ...
            <div className="mb-3 w-full">
                ...
                <input value={info.name} onChange={(e)=>changeInfo(e)} type="text" name="name" className="px-2 py-2 border w-full outline-none rounded-md" id="exampleInput90" placeholder="Name" />
            </div>
            ...
            <div className="mb-3 w-full">
                ...
                <input value={info.email} onChange={(e)=>changeInfo(e)} name="email" type="email" className="px-2 py-2 border w-full outline-none rounded-md" id="exampleInput90"
            ...
            <div className="mb-3 w-full">
                ...
                <textarea value={info.message} onChange={(e)=>changeInfo(e)} name="message" className="px-2 py-2 border rounded-[5px] w-full outline-none" id=""></textarea>
            </div>
